(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcApp_servicesCharactersServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CharactersService = /*#__PURE__*/function () {
        function CharactersService(httpService) {
        ...
        _createClass(CharactersService, [{
          ...
          value: function getCharactersList() {
            var pageUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            ...
            var url = pageUrl != null ? pageUrl : _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseAppUrlSecure + 'people/'; //if we have a search keyword we concat it to the url as mentoind in swapi documentation
          ...
          value: function getCharacter(characterId) {
            var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseAppUrlSecure + 'people/' + characterId;
            return this.httpService.get(url);
          }
        }]);
      ...
      CharactersService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], CharactersService);
      /***/
    }
