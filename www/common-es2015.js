...
let CharactersService = class CharactersService {
    ...
    getCharactersList(pageUrl = null, keyword = "") {
        ...
        let url = (pageUrl != null) ? pageUrl : _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseAppUrlSecure + 'people/';
    ...
    getCharacter(characterId) {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseAppUrlSecure + 'people/' + characterId;
        return this.httpService.get(url);
    }
};
